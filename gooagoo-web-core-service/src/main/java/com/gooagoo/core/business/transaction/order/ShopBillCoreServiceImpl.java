        ...
        if (CollectionUtils.isNotEmpty(originalBillDetailList))
        {
            for (OriginalBillDetail originalBillDetail : originalBillDetailList)
            {
                ...
                {//新建
                    ...
                    GoodsBaseInfo goodsBaseInfo = this.transactionProtectedCoreService.getGoodsBaseInfoFromDB(shopEntityId, originalBillDetail.getGoodsName(), originalBillDetail.getItemSerial());
