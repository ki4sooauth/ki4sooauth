...
import com.gooagoo.api.business.core.statistics.UseStatisticCoreService;
...
@Service
public class UseStatisticCoreServiceImpl implements UseStatisticCoreService
{
    /**
     * 判断是否是今天
     * @param dateTime
    ...
    public int toolUseTimes(String shopId, String toolId, String dateType, String userType, Date dateTime)
    {
        ...
        if (this.isToday(dateTime))
        {
            ...
            String valueSource = this.jointValueForRedis(toolId, "U", userType, dateType, dateTime);
    ...
    public List<String> toolUsePoeple(String shopId, String toolId, String dateType, String userType, Date dateTime)
    {
        ...
        if (this.isToday(dateTime))
        {
            //redis 查询商家所有实体店店内人群
            RedisSortedSetDao sortedSetDao = new RedisSortedSetDao(RedisServerConstants.statistics_tools);
            String key = this.jointKeyForRedis(toolId, "U", dateType, userType, dateTime);
    ...
    public int couponUseTimes(String couponId, String userType, String dateType, Date dateTime)
    {
        ...
        if (this.isToday(dateTime))
        {
            ...
            String valueSource = this.jointValueForRedis(couponId, "U", userType, dateType, dateTime);
    ...
    public List<String> couponUsePeople(String couponId, String userType, String dateType, Date dateTime)
    {
        ...
        if (this.isToday(dateTime))
        {
            //redis 查询商家所有实体店店内人群
            RedisSortedSetDao sortedSetDao = new RedisSortedSetDao(RedisServerConstants.statistics_coupon);
            String key = this.jointKeyForRedis(couponId, "U", dateType, userType, dateTime);
            Set<String> set = sortedSetDao.get(key, 0, sortedSetDao.zcard(key));
