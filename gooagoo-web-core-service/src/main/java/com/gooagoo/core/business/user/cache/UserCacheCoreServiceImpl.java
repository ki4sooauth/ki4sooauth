...
public class UserCacheCoreServiceImpl implements UserCacheCoreService
{
    ...
    @Autowired
    UserMobileInfoMapper userMobileInfoMapper;
    ...
    public String findUserIdByMac(String mac) throws Exception
    {
        ...
        if (StringUtils.isBlank(userId))
        {
            ...
            example.setPage(0, 1);
            List<UserMobileInfo> mobileInfos = this.userMobileInfoMapper.selectByExample(example);
    ...
    private Map<String, String> assembling(String userId)
    {
        ...
        UserProfile userProfile = userProfileMapper.selectByPrimaryKey(userProfileKey);
        UserMobileInfoKey userMobileInfoKey = new UserMobileInfoKey();
        userMobileInfoKey.setUserId(userId);
        UserMobileInfo userMobileInfo = userMobileInfoMapper.selectByPrimaryKey(userMobileInfoKey);
        Map<String, String> user = new HashMap<String, String>();
        user.put("mac", userMobileInfo.getMacAddress());
