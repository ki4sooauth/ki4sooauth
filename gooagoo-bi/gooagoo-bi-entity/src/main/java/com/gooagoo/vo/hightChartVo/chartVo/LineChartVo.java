...
import com.gooagoo.vo.hightChartVo.base.Labels;
import com.gooagoo.vo.hightChartVo.base.Legend;
import com.gooagoo.vo.hightChartVo.base.PlotLines;
...
import com.gooagoo.vo.hightChartVo.base.Subtitle;
...
public class LineChartVo implements Serializable {
	...
	private void init() {
		this.chart = new Chart("container", null, null, null, "line", 300, 750, 25, 50);
		...
		this.legend = new Legend("horizontal", "center", "bottom", 20, 0, 0, null, null, null, null, null);
		plotOptions.setColumn(column);
