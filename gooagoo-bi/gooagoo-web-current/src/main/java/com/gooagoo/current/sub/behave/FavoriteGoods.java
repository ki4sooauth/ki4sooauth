...
public class FavoriteGoods implements Customer
{
    @Override
    public void message(Object message)
    {
        GooagooLog.debug("启动任务 FavoriteGoods");
    ...
    private void put(GoodsCache goodsCache, String value, String member, String channel, String source)
    {
        if (StringUtils.hasText(value, member, channel, source))
        {
            ...
            for (String shop : new String[] { goodsCache.getShopId(), goodsCache.getShopEntityId() })
            {
                ...
                {
                    String categoryBaseKey = shop + "_" + category + "_F_" + member + "_" + channel + "_" + source;
                    this.redisPut(goodsCategory, categoryBaseKey, value);
                }
                String brandBaseKey = shop + "_" + goodsCache.getGoodsBrand() + "_F_" + member + "_" + channel + "_" + source;
                this.redisPut(goodsBrand, brandBaseKey, value);
                String serialBaseKey = shop + "_" + goodsCache.getItemSerial() + "_F_" + member + "_" + channel + "_" + source;
