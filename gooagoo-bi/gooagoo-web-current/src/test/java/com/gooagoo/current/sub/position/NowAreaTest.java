...
public class NowAreaTest
{
    NowArea nowArea = new NowArea();
    ...
    public void after()
    {
        ...
        leave.setId("183M36UQ8HVKTV2G8TELDKNPHJ3LGCUG");
        leave.setStart(1378368863941L); //开始时间戳
        leave.setEnd(1378368873941L); //结束时间戳
        leave.setDuration(1); //时长(分钟)
        position.getOldArea().add(leave);//.add("183M36UQ8HVKTV2G8TELDKNPHJ3LGCUG");
        nowArea.message(position);
    }
}
