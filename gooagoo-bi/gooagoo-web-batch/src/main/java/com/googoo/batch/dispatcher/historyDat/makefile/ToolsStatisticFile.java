...
public class ToolsStatisticFile implements Tyre
{
    private final MongoDao dao = new MongoDao(MongoConstants.MONGO_URL, MongoConstants.makefileDB, CollectionConstants.TOOLS_FILE_INFO);
    ...
    public void run()
    {
        ...
        for (DBObject obj : all)
        {
            ...
            this.statistic(id, uses);
        }
    }

    private void statistic(String id, DBObject uses)
    {
