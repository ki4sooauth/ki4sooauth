...
public class ShopToolInfoFile implements Tyre
{
    private final RedisSortedSetDao redisDao = new RedisSortedSetDao(RedisServerConstants.statistics_tools);
    private final MongoDao tools_file_dao = new MongoDao(MongoConstants.MONGO_URL, MongoConstants.makefileDB, CollectionConstants.TOOLS_FILE_INFO);
    ...
    private void statistic(String value, String dateType)
    {
        ...
        _id.append(ids[0]).append("_" + ids[1]).append("_" + ids[3]).append("_" + dateType);
        ...
        this.tools_file_dao.update(query, new BasicDBObject().append("$set", obj));
    }
