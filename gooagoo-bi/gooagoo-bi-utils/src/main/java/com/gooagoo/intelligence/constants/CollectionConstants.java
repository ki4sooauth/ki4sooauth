package com.gooagoo.intelligence.constants;
...
public class CollectionConstants
{
    ...
    public static final String GOODSSERIAL_NUM = "goodsSerial_num";
    public static final String GOODSSERIAL_NUMS = "goodsSerial_nums";
    public static final String GOODSCATEGORY_NUM = "goodsCategory_num";
    public static final String GOODSCATEGORY_NUMS = "goodsCategory_nums";
    public static final String GOODSBRAND_NUM = "goodsBrand_num";
    public static final String GOODSBRAND_NUMS = "goodsBrand_nums";
    ...
    /**生成文件*/
    public final static String ACTIVITY_FILE_INFO = "activity_file_info";
    public final static String NOTICE_FILE_INFO = "notice_file_info";
    public final static String CRYOUT_FILE_INFO = "cryout_file_info";
    public final static String SHOPINGPRY_FILE_INFO = "shopingpry_file_dao";
    public final static String COUPON_FILE_INFO = "coupon_file_info";
    public final static String TOOLS_FILE_INFO = "tools_file_info";
    public final static String PHONETOOL_FILE_INFO = "phonetool_file_info";
    public final static String GOODSSERIAL_FILE_INFO = "goodsSerial_file_info";
    public final static String GOODSCATEGORY_FILE_INFO = "goodsCategory_file_info";
    public final static String GOODSBRAND_FILE_INFO = "goodsBrand_file_info";
}
