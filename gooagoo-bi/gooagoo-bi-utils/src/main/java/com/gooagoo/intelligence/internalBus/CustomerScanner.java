...
{
    private GooagooLog logger = new GooagooLog("framework");
    /**
     ...
     * @param classFilters
     */
    public CustomerScanner(Boolean excludeInner, Boolean checkInOrEx, List<String> classFilters)
    {
