...
public interface ShopEntityLinkGeneratorCoreService
{

    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于查询表中对应数据条数
     * @param shopEntityLinkExample 查询条件
     * @return 数据条数
     */
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于查询数据，其中 create_time自动设置为当前数据库时间
     * @param shopEntityLinkExample 查询条件
     * @return 
     */
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于查询数据
     * @param shopEntityLinkKey 查询条件，is_del默认为N,如果不想使用此条件请设置为null
     * @return 
     */
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于删除操作（本系统数据库删除操作非物理删除，请慎用）
     * @param shopEntityLinkExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于逻辑删除数据（修改is_del值为Y)
     * @param shopEntityLinkExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于往表中添加数据
     * @param shopEntityLink 插入数据
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表shop_entity_link用于更新数据，其中 create_time不提供修改功能， c_time_stamp自动设置为当前数据库时间
     * @param shopEntityLink 更新数据
     * @param shopEntityLinkExample 更新条件
