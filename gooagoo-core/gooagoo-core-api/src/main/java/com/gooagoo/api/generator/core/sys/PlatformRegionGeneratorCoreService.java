...
public interface PlatformRegionGeneratorCoreService
{
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表platform_region用于删除操作（本系统数据库删除操作非物理删除，请慎用）
     * @param platformRegionExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表platform_region用于逻辑删除数据（修改is_del值为Y)
     * @param platformRegionExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表platform_region用于往表中添加数据
     * @param platformRegion 插入数据
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表platform_region用于更新数据，其中 create_time不提供修改功能， c_time_stamp自动设置为当前数据库时间
     * @param platformRegion 更新数据
     * @param platformRegionExample 更新条件
