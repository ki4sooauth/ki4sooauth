...
public interface BrowseStatisticQueryService
{
    ...
    * @param shopId  实体店id或商家id
     ...
     * @return
     */
    public abstract int brandBrowsTimes(String shopId, String brandId, String dateType, String userType, String channel, Date dateTime, String source);
