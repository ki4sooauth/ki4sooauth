...
public interface UserMobileInfoGeneratorCoreService
{
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表user_mobile_info用于删除操作（本系统数据库删除操作非物理删除，请慎用）
     * @param userMobileInfoExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表user_mobile_info用于往表中添加数据
     * @param userMobileInfo 插入数据
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表user_mobile_info用于更新数据，其中 create_time不提供修改功能， c_time_stamp自动设置为当前数据库时间
     * @param userMobileInfo 更新数据
     * @param userMobileInfoExample 更新条件
