...
public interface RuleResultGeneratorCoreService
{

    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于查询表中对应数据条数
     * @param ruleResultExample 查询条件
     * @return 数据条数
     */
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于查询数据，其中 create_time自动设置为当前数据库时间
     * @param ruleResultExample 查询条件
     * @return 
     */
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于查询数据
     * @param ruleResultKey 查询条件，is_del默认为N,如果不想使用此条件请设置为null
     * @return 
     */
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于删除操作（本系统数据库删除操作非物理删除，请慎用）
     * @param ruleResultExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于逻辑删除数据（修改is_del值为Y)
     * @param ruleResultExample 删除条件
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于往表中添加数据
     * @param ruleResult 插入数据
    ...
    /**
     * This method was generated by PengYb
     * 此方法对应数据库表rule_result用于更新数据，其中 create_time不提供修改功能， c_time_stamp自动设置为当前数据库时间
     * @param ruleResult 更新数据
     * @param ruleResultExample 更新条件
