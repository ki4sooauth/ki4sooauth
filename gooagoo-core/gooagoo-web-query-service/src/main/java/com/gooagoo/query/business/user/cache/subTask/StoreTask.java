...
public class StoreTask implements Callable<Set<Account>>
{
    private String shopId;
    private ActionAttribute actionAttribute;
    private String[] userIds;

    public StoreTask(String shopId, ActionAttribute actionAttribute, String[] userIds)
    {
        super();
        this.shopId = shopId;
    ...
    public Set<Account> query() throws Exception
    {
        ...
        MongoDao mongoDao = new MongoDao(MongoConstants.MONGO_URL, MongoConstants.analysisDB, CollectionConstants.ANLS_ARRIVAL_SHOP);
