 ...
 */
@Service
public class ShopEntityCacheQueryServiceImpl implements ShopEntityCacheQueryService
{
    ...
    private Map<String, String> init(String shopEntityId)
    {
        ...
        ShopEntityInfo shopEntityInfo = this.shopEntityInfoGeneratorQueryService.selectByPrimaryKey(shopEntityId);
        if (shopEntityInfo != null)
        {
            ...
            ShopGpsInfo shopGpsInfo = this.shopGpsInfoGeneratorQueryService.selectUnDelByPrimaryKey(shopEntityId);
            if (shopGpsInfo != null)
            {
