package com.gooagoo.query.business.goods.cache;
...
import com.gooagoo.common.utils.CollectionQueryUtils;
 ...
 */
@Service
public class GoodsCacheQueryServiceImpl implements GoodsCacheQueryService
{
    @Autowired
    ...
    private Map<String, String> assembling(String goodsId) throws Exception
    {
        ...
        if (goodsBaseInfo != null)
        {
            ...
            GoodsMarketingInfo marketingInfo = this.goodsMarketingInfoGeneratorQueryService.selectUnDelByPrimaryKey(goodsId);
            if (marketingInfo != null)
            {
                ...
                ShopPosition shopPosition = this.shopPositionGeneratorQueryService.selectUnDelByPrimaryKey(marketingInfo.getPositionId());
            ...
            CollectionQueryUtils.filterNullValue4Map(result);
        }
        return result;
    }
    ...
    public Map<String, String> findGoodsCategory(String shopEntityId, String categoryId) throws Exception
    {
        ...
        if (result == null || result.size() == 0)
        {
            ...
            List<GoodsCategory> category = this.goodsCategoryGeneratorQueryService.selectByExample(example);
