...
import com.gooagoo.api.business.core.marketing.cache.CryoutCacheCoreService;
 ...
 */
@Service
public class CryoutCacheCoreServiceImpl implements CryoutCacheCoreService
{
    ...
    public void initCache(String userId)
    {
        ...
        while (true)
        {
            ...
            List<MarketingUserLink> links = this.marketingUserLinkGeneratorCoreService.selectByExample(example);
