...
public class UserOrderCoreServiceImpl implements UserOrderCoreService
{
    ...
    public OrderResult addUserOrder(ConsigneeInfo consigneeInfo, UserOrderInfo userOrderInfo, List<UserOrderDetail> userOrderDetailList, List<UserOrderCoupon> userOrderCouponList, Map<String, String> parmMap) throws Exception
    {
        ...
        this.completionOrder(userOrderInfo, userOrderDetailList, userOrderCouponList, canNotUseCouponList, orderBusiness);
        ...
        this.save(userOrderInfo, userOrderDetailList, userOrderCouponList, orderBusiness);
     ...
     * @throws Exception
     */
    private OrderBusiness completionOrder(UserOrderInfo userOrderInfo, List<UserOrderDetail> userOrderDetailList, List<UserOrderCoupon> userOrderCouponList, List<CanNotUseCoupon> canNotUseCouponList, OrderBusiness orderBusiness) throws Exception
    {
    ...
    private void save(UserOrderInfo userOrderInfo, List<UserOrderDetail> userOrderDetailList, List<UserOrderCoupon> userOrderCouponList, OrderBusiness orderBusiness) throws Exception
    {
        //保存用户订单
