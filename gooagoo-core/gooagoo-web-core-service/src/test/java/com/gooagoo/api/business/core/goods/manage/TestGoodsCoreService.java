...
public class TestGoodsCoreService extends AbstractTransactionalJUnit4SpringContextTests
{
    ...
    *//**
    ...
    {
     RedisDatabase dao = new RedisDatabase(RedisServerConstants.business_shop);
     dao.del("01822JF4R28QLJF07GRNH1EIISWR2K8D");
     String goodsId = "01822U4ETOPRKDK07GRNHLEIISWR2K8D";
