...
public class ActionAttribute implements Serializable
{
    ...
    private String marketingEvent;//事件：事件ID，多个用英文半角逗号隔开
    ...
    private String marketingEventName;//事件：事件名称，多个用英文半角逗号隔开
