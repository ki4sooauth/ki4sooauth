...
public class ShopAndUserInfo implements Serializable
{
    ...
    private String userHeadImg;//店员头像
    ...
    {
        return "ShopAndUserInfo [shopId=" + this.shopId + ", shopEmail=" + this.shopEmail + ", shopNickName=" + this.shopNickName + ", shopStatus=" + this.shopStatus + ", shopIsChain=" + this.shopIsChain + ", shopServiceStyle=" + this.shopServiceStyle + ", shopName=" + this.shopName + ", shopTypeRoot=" + this.shopTypeRoot + ", shopTypeLeaf=" + this.shopTypeLeaf + ", shopLogo1=" + this.shopLogo1 + ", shopLogo2=" + this.shopLogo2 + ", shopLogo3=" + this.shopLogo3 + ", shopScope=" + this.shopScope + ", shopNote=" + this.shopNote + ", userId=" + this.userId + ", userIsShopAccount=" + this.userIsShopAccount + ", userPassword=" + this.userPassword + ", userStatus=" + this.userStatus + ", userName=" + this.userName + ", userSex=" + this.userSex + ", userBirthday=" + this.userBirthday + ", UserIdType=" + this.UserIdType + ", userIdNo=" + this.userIdNo + ", userShopEntityId=" + this.userShopEntityId + ", userBrand=" + this.userBrand + ", userHeadImg=" + this.userHeadImg + "]";
    }
