...
public class ShortMessage implements Serializable
{
    ...
    {
        return this.messageId + "^" + this.shopId + "^" + this.activityId + "^" + this.messageTitle + "^" + this.content + "^" + this.publishStatus + "^" + this.auditNote + "^" + this.ruleId + "^" + this.isDel + "^" + this.createTime + "^" + this.cTimeStamp;
    }
}
