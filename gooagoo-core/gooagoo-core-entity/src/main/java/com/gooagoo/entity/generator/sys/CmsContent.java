...
public class CmsContent implements Serializable
{
    ...
    {
        return this.cmsContentId + "^" + this.cmsContentType + "^" + this.parentCmsContentId + "^" + this.channelType + "^" + this.shopId + "^" + this.cmsContentName + "^" + this.cmsContentImg + "^" + this.cmsContentDes + "^" + this.cmsContentUrl + "^" + this.templateId + "^" + this.templateData + "^" + this.isTop + "^" + this.orderNo + "^" + this.publishStatus + "^" + this.auditNote + "^" + this.publishTime + "^" + this.isDel + "^" + this.createTime + "^" + this.cTimeStamp;
    }
}
