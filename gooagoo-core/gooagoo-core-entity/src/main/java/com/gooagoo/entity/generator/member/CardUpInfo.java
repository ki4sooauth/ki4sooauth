...
public class CardUpInfo implements Serializable
{
    ...
    {
        return this.id + "^" + this.userId + "^" + this.shopId + "^" + this.cardId + "^" + this.upCardId + "^" + this.needIntegral + "^" + this.phyNo + "^" + this.phyName + "^" + this.name + "^" + this.sex + "^" + this.birthday + "^" + this.idType + "^" + this.idNo + "^" + this.mobile + "^" + this.telephone + "^" + this.email + "^" + this.postcode + "^" + this.status + "^" + this.auditNote + "^" + this.isDel + "^" + this.createTime + "^" + this.cTimeStamp;
    }
}
