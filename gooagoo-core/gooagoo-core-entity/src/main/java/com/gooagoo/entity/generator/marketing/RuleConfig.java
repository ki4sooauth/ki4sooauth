...
public class RuleConfig implements Serializable
{
    ...
    {
        return this.id + "^" + this.shopId + "^" + this.behaveType + "^" + this.isShowDateScope + "^" + this.isShowWeekScope + "^" + this.isShowTimeScope + "^" + this.isShowVipGrade + "^" + this.isShowActionSource + "^" + this.isShowTime + "^" + this.isShowTotalTime + "^" + this.isShowMarketingGoodsCategory + "^" + this.isShowMarketingGoodsBrand + "^" + this.isShowMarketingGoods + "^" + this.isShowMarketingAction + "^" + this.isShowMarketingCoupon + "^" + this.isShowMarketingEvent + "^" + this.isShowServerTools + "^" + this.isShowPosition + "^" + this.isShowDuration + "^" + this.isShowConsumeMoney + "^" + this.isShowVb + "^" + this.isDel + "^" + this.createTime + "^" + this.cTimeStamp;
    }
}
