...
public class NaturalAttribute implements Serializable
{
    ...
    private List<MemberFeature> memberFeatureList = new ArrayList<MemberFeature>();//会员特征列表
    ...
    public void setMemberFeatureList(List<MemberFeature> memberFeatureList)
    {
        this.memberFeatureList = memberFeatureList;
    }
