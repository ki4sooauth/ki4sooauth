...
<link rel="icon" type="image/png" href="${imgPath }/common/svg-edit-2.6/images/logo.png"/>
<link rel="stylesheet" href="${imgPath }/common/svg-edit-2.6/jgraduate/css/jPicker.css" type="text/css"/>
<link rel="stylesheet" href="${imgPath }/common/svg-edit-2.6/jgraduate/css/jgraduate.css" type="text/css"/>
<link rel="stylesheet" href="${imgPath }/common/svg-edit-2.6/svg-editor.css" type="text/css"/>
<link rel="stylesheet" href="${imgPath }/common/svg-edit-2.6/spinbtn/JQuerySpinBtn.css" type="text/css"/>


<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/jquery.js"></script>


<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/js-hotkeys/jquery.hotkeys.min.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/jquerybbq/jquery.bbq.min.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/svgicons/jquery.svgicons.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/jgraduate/jquery.jgraduate.min.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/spinbtn/JQuerySpinBtn.min.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/touch.js"></script>

<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/contextmenu/jquery.contextMenu.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/browser.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/svgtransformlist.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/math.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/units.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/svgutils.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/sanitize.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/history.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/select.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/draw.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/path.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/svgcanvas.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/svg-editor.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/locale/locale.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/contextmenu.js"></script>
...
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
<script type="text/javascript" src="${imgPath }/common/svg-edit-2.6/jgraduate/jpicker.js"></script>
...
<script>
function saveSvgStr(){
    var svgStr = $("#svg_source_textarea").val() ;
    var shopEntityId = '${shopEntityId }' ;
    var mapId = '${mapId }' ;
    var data = "&svgStr="+svgStr + "&shopEntityId=" + shopEntityId
    		  + "&mapId=" + mapId;
    $.ajax({
    	async:false ,
    	type:"POST",
    	url:"${basePath}/svg.do?method=updateSvgDo",
    	data:data,
    	success:function(ret) {
    		if(ret.length == 32)
    			location.href="${basePath}/map.do?method=perfect&mapId=" + ret +"&shopEntityId=" + shopEntityId ;
    		else alert("修改失败") ;
    	}
    });
}
...
<div id="tools_left" class="tools_panel">
	...
	<div class="tool_button" id="tool_image" title="位置标签"></div>
	<div class="tool_button" id="tool_image2" title="Wifi Sensor"></div>
...
<div id="svg_source_editor">
	...
	<div id="svg_source_container">
		<div id="tool_source_back" class="toolbar_button">
			...
			<button onclick="saveSvgStr();">保存</button>
		</div>
