...
public class FNaturalAttribute implements Serializable
{
    ...
    private List<FMemberFeature> memberFeatureList = new ArrayList<FMemberFeature>();//会员特征列表
    ...
    public List<FMemberFeature> getMemberFeatureList()
    {
        return this.memberFeatureList;
    }

    public void setMemberFeatureList(List<FMemberFeature> memberFeatureList)
    {
