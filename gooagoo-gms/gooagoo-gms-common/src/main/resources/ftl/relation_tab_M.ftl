		...
		<#list pm.result as itemChild>
			<tr>
				...
				<td style="display:none;">
					<input type="hidden" name="relate_data" value="M"/>	
					<input type="hidden" name="relate_data" value="${itemChild.cryoutInfoId}"/>
					<input type="hidden" name="relate_data" value="${itemChild.cryoutTitle}"/>
					<input type="hidden" name="relate_data" value="${itemChild.cryoutType}"/>
				</td>
			</tr>
		</#list>
		<tr>
