...
public class OrderInfoAction extends BaseAction
{
    ...
    {
        @SuppressWarnings("rawtypes")
        TransData<PageModel> transData = GMSUtil.httpClientRequest(InterGmsConstants.I_GMS_APPLY_PAGE_ORDER_INFO, request, PageModel.class);
        @SuppressWarnings("unchecked")
    ...
    {
        TransData<FOrderInfo> transData = GMSUtil.httpClientRequest(InterGmsConstants.I_GMS_APPLY_PAGE_ORDER_INFO_DETAIL, request, FOrderInfo.class);
        FOrderInfo info = transData.getData();
        request.setAttribute("orderInfo", info);
        return "orderInfo/mailDetail";
    }
    ...
    {
        @SuppressWarnings("rawtypes")
        TransData<PageModel> transData = GMSUtil.httpClientRequest(InterGmsConstants.I_GMS_APPLY_ORDER_DETAIL_INFO, request, PageModel.class);
        @SuppressWarnings("unchecked")
        ...
        return "orderInfo/orderGoodsDetail";
    }
}
