...
<script type="text/javascript" src="${imgPath}/gms/apply/js/orderDetail.js"></script>
	...
	<div class="container">
		<div class="article">
			...
			<div class="section">
				...
				<div class="file_nav">
					<a href="javascript:void(0);" onclick="switchTab(this);pageDetail(1,'${orderid}');" class="curr" id="A">订单信息</a> 
					<a href="javascript:void(0);" onclick="switchTab(this);pageDetail(1,'${orderid}');" id="B">订单商品详细信息</a>
