...
<script type="text/javascript">
	var cbody=true;
  	...
  	function selectParent(){
	  	...
	  	var url = "${basePath }relation.do?method=listRelation&relateType=J&dataType=MS&entityId="+entityId;
      	...
      	<div class="article">
            ...
            <div class="section">
            	<div class="rightTitle">
	             	<span>${shopVo.wordNames['gmsb030']}</span>
	            </div>
