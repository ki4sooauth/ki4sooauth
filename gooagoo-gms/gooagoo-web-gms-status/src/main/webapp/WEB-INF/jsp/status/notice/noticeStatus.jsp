...
<%
	...
	request.setAttribute("leftMenuCode", "1111");
%>
...
<script type="text/javascript">
	var statusFlag="notice";
   	...
   	function selectParent(){
	  	var url = "${basePath}relation.do?method=listRelation&relateType=N&activityId=";
