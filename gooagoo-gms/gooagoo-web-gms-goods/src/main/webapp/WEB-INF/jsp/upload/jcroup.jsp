...
<title>${shopVo.wordNames['gmse053']}</title>
</head>
...
<div class="alter_boxpop" style="width:880px;">
	<div class="alterBoxTop">
		<a id="BtnSaveAvatar" href="javascript:void(0);" class="blueBtn">${shopVo.wordNames['gmse053']}</a>
	   ${shopVo.wordNames['gmse078']}
	</div>
	...
	<a href="javascript:void(0);" onclick="uploadPath('${basePath}');" class="confirm_btn blueBtn">${shopVo.wordNames['gmse077']}</a>
</div>
</body>
</html>