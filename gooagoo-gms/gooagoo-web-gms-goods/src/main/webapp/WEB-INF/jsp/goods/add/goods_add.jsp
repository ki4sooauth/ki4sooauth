...
<title>${shopVo.wordNames['gmse034']}</title>
...
<script type="text/javascript" src="${imgPath}/gms/goods/js/goods_add.js"></script>
...
function relateOne(relateType){
	var entityId = $("select[name='entityId']").val();
	var url = "" ;
	// 品类
	if(relateType == "J") {
		...
		<div class="article">
			...
			<div class="section">
				<div class="rightTitle">
					<span>${shopVo.wordNames['gmse035']}</span>
				</div>
				<div class="conditions_content">
				    <!-- 商品基本信息 -->
					<%@include file="/WEB-INF/jsp/goods/add/add_goods_base.jsp"%>
					<div class="title">
					  <check:hasAuthority authorityID="15010102">
						<a href="javascript:void(0)" class="addProduct orangeBtn" onclick="showMsg();">${shopVo.wordNames['gmse036']}</a>${shopVo.wordNames['gmse037']}
					  </check:hasAuthority>
					</div>
					...
					<!-- 商品营销信息 -->
					<%@include file="/WEB-INF/jsp/goods/add/add_marketing.jsp"%>
				</div>
			</div>
		</div>
	</div>
