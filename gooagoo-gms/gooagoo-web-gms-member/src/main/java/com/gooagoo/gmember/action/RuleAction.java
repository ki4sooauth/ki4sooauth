...
public class RuleAction extends BaseAction
{
    ...
    {
        request.setAttribute("ruleTypes", "7");
        ...
        PageModel<FRule> pm = respObj.getData();
    ...
    public String formCheck(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        String ruleId = ServletRequestUtils.getStringParameter(request, "ruleId", "");
