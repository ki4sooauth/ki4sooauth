	...
	<div style="width: 400px;">
		<ul class="desk-num-poup" style="width: 350px;">
			...
			<li><span>${shopVo.wordNames['cpme065']}</span>&nbsp;</li>
		 	...
		 	<li class="commitBtn">
		 		<check:hasAuthority authorityID="240302"><input type="button" style="width: 100px" onclick="approval('${id}','Y');"  class="inputBtn blueBtn" value="${shopVo.wordNames['cpme042']}"></check:hasAuthority>&nbsp;&nbsp;&nbsp;&nbsp;
		 		<input type="button" style="width: 100px;" onclick="approval('${id}','N');"  class="inputBtn blueBtn" value="${shopVo.wordNames['cpme043']}">
		 	</li>
		</ul>
	</div>
</body>
