...
<script type="text/javascript" src="${imgPath}/gms/member/js/card/createAdvanceCard.js" charset="UTF-8"></script>
<form:form id="cardCreateForm" method="post" modelAttribute="memberCard">
	<div class="memberBuild">
		...
		<ul>
		  	<li>
			  	<span>${shopVo.wordNames['cpme013']}</span>
		   	...
		   	<li>
				<span>${shopVo.wordNames['cpme018']}</span>
		    ...
		    <li>
		     	<span>${shopVo.wordNames['cpme019']}</span>
			...
			<li>
		 		<span>${shopVo.wordNames['cpme020']}</span>
			...
			<li>
				<span>${shopVo.wordNames['cpme028']}</span>
				<input type="text" name="needJifen" value="${memberCard.needJifen}" class="inputStyle" maxlength="11"/>
			</li>
			<li>
		...
		<div class="conserve">
			<input type="hidden" name="cardLvl" value="2"/>
