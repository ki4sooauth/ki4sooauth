...
<body>
	...
	<div class="section_pop" style="width: 96%;padding: 20px;">
	...
	function doSubmit(){
		...
		if(checkHasValue()){
			var url = "${basePath}activityCont.do?method=release";
			var contentId = $("input[name='contentId']").val();
			var channelCode = $("input[name='channelCode']").val();
			var data = $("#memberSearchForm").serialize()+"&contentId="+contentId+"&channelCode="+channelCode;
			$.ajax({
		        type: "POST",
		        async: false,
		        url: url,
