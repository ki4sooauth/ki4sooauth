		...
		<ul class="desk-num-poup">
				...
				<li><span>${shopVo.wordNames['gmsg144']}</span>&nbsp;
				 <select class="borderStyle select"  id="shopEntityId" name="shopEntityId" >
				   ...
				   <option ${tableType.shopEntityId eq entity.shopEntityId?"selected=selected":""}  value="${entity.shopEntityId}">${entity.shopEntityName}</option>
				   </c:forEach>
				 </select>
				 </li>
				 </div>
			<li><span>类型名称</span>&nbsp;
			<input type="hidden" name="tableTypeCode" value="${tableType.id}"  />
			<input class="borderStyle text"
				type="text" name="tableTypeName" value="${tableType.name}" maxlength="50" /></li>
			<li><span>最小人数</span>&nbsp;<input class="borderStyle text"
				type="text" name="minNums" value="${tableType.minNums}"
				maxlength="50" /></li>
			<li><span>最大人数</span>&nbsp;<input class="borderStyle text"
				type="text" name="maxNums" value="${tableType.maxNums}"
				maxlength="50" /></li>
