package com.gooagoo.casclient.zookeeper;
...
public abstract class AbstractZooKeeper implements Watcher
{
    ...
    public AbstractZooKeeper()
    {
        ...
        {
            CasLog.error("初始化到【" + this.host + "】的连接失败", e);
        }
    }
    ...
    public void connect() throws IOException, InterruptedException
    {
        ...
        CasLog.info("建立到【" + this.host + "】的zookeeper连接，耗时" + (end - start) + "毫秒");
    }
    ...
    public void close()
    {
        try
        {
            ...
            CasLog.info("关闭到【" + this.host + "】的zookeeper连接");
        }
        catch (Exception e)
        {
            CasLog.error("关闭到【" + this.host + "】的zookeeper连接异常", e);
        }
    }
    ...
    {
        CasLog.info("监听到【" + this.host + "】：" + arg0.getPath() + "^" + arg0.getState() + "^" + arg0.getType());
