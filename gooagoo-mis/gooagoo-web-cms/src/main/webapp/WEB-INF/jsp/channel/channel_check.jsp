...
<script type="text/javascript">
	function checkChannel(cmsContentId,status){
    	...
    	<div>
	    	<div style="margin-top:10px;margin-bottom:8px">
	      	...
	      	<div style="margin:10px; text-align:center;">
	      		<a href="#" onclick="checkChannel('${cmsContentId}','Y');" style="width: 80px; height: 28px;line-height: 28px; background: none repeat scroll 0 0 #42748B;" class="inputBtn blueBtn"><strong>通过</strong></a>
	      		<span style="width:10px;">&nbsp;</span>
	      		<a href="#" onclick="checkChannel('${cmsContentId}','N');" style="width: 80px; height: 28px;line-height: 28px; background: none repeat scroll 0 0 #42748B;" class="inputBtn blueBtn"><strong>不通过</strong></a>
		  	</div>
    	</div>
	</div>
</body>
