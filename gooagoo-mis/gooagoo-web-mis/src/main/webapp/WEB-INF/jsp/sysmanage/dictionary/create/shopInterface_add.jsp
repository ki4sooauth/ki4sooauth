		...
		<form action="" method="post" id="addForm" name="addForm">
			<ul>
				<li><span><code>*</code>名称编码：</span>
					<input type="text" class="name_input" id="nameCode" name="nameCode" />
					<label class="wrong" id="lblNameCode" style="display: none;">请输入名称编码！</label>
				</li>
				<li><span><code>*</code>名称值：</span>
					<input type="text" class="name_input" id="nameValue" name="nameValue" />
				...
				<li><span><code>*</code>所属模块：</span>
					<input type="text" class="name_input" id="module" name="module" />
				...
				<li><span><code>*</code>版本号说明：</span>
					<input type="text" class="name_input" id="versionNote" name="versionNote" />
...
function saveDic() {
	if (checkNameCode() && checkNameValue() && checkSys() && checkModule() && checkVersion() && checkVersionNote()) {
		var url = "shopInter.do?method=addDict";
