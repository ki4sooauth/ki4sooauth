	...
	<div class="user_message">
		<form action="" method="post" id="addForm" name="addForm">
			<ul style="width : 500px;">
				<li><span><code>*</code>商家类型名称：</span>
					<input type="text" class="name_input" id="shopTypeName" name="shopTypeName" />
					<label class="wrong" id="lblShopTypeName" style="float:none; display: none;">请输入商家类型名称！</label>
				</li>
				<li><span><code>*</code>上级类型编号：</span>
					<input type="text" class="name_input" id="parentShopTypeId" name="parentShopTypeId" />
...
function saveDic() {
	if (checkShopTypeName() && checkParentShopTypeId() && checkFrontPic() && checkBackPic() && checkSortOrder()) {
		var url = "shopType.do?method=addDict";
