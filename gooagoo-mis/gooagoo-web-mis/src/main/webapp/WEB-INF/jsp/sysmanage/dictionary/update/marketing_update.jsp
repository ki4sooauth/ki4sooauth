...
<div class="user_message">
	<form action="" method="post" id="addForm" name="addForm">
		<ul>
			<li>
				<span><code>*</code>营销渠道编码：</span>
				<input type="hidden" name="channelCode" value="${marketing.channelCode }"/>
				${marketing.channelCode }
			</li>
			<li>
				<span><code>*</code>营销渠道名称：</span>
				<input type="hidden" name="channelCode" value="${marketing.channelCode }"/>
				<input type="text"  class="name_input" id="channelName" name="channelName" value="${marketing.channelName }"/>
				<label class="wrong" id="lblChannelName" style="display: none;">请输入营销渠道名称！</label>
			</li>
			<li>
				<span><code>*</code>父级编码：</span>
				<input type="text"  class="name_input" id="parentChannelCode" name="parentChannelCode" value="${marketing.parentChannelCode }"/>
				<label class="wrong" id="lblParentChannelCode" style="display: none;">请输入父级编码！</label>
			</li>
			<li>
				<span><code>*</code>排序号：</span>
				<input type="text"  class="name_input" id="sortOrder" name="sortOrder" value="${marketing.sortOrder }"/>
...
//保存字典 
function saveDic() {
	if (checkChannelName() && checkParentChannelCode() && checkSortOrder()) {
		var url = "market.do?method=editDict";
