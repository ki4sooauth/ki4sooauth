		...
		<form action="" method="post" id="addForm" name="addForm">
			<ul>
				<li><span><code>*</code>权限ID：</span>
					<input type="hidden" name="authorityId" value="${sysAuthority.authorityId}"/>
					${sysAuthority.authorityId}
				</li>
				<li><span><code>*</code>权限名称：</span>
					<input type="text" class="name_input" id="authorityName" name="authorityName" value="${sysAuthority.authorityName}"/>
					<label class="wrong" id="lblAuthorityName" style="display: none;">请输入权限名称！</label>
				</li>
				<li><span><code>*</code>父权限ID：</span>
					<input type="text" class="name_input" id="parentAuthorityId" name="parentAuthorityId" value="${sysAuthority.parentAuthorityId}"/>
					<label class="wrong" id="lblParentAuthorityId" style="display: none;">请输入父权限ID！</label>
				</li>
				<li><span class="f_b_t">链接：</span>
					<input type="text" class="name_input" id="link" name="link" value="${sysAuthority.link}"/>
				</li>
				<li><span><code>*</code>排序编号：</span>
					<input type="text" class="name_input" id="orderNo" name="orderNo" value="${sysAuthority.orderNo}"/>
...
function saveDic() {
	if (checkAuthorityId() && checkAuthorityName() && checkParentAuthorityId() && checkOrderNo()) {
		var url = "sysAuth.do?method=editDict";
