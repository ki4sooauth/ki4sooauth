...
<div class="user_message">
	<form action="" method="post" id="addForm" name="addForm">
		<ul>
			<li>
				<span><code>*</code>省市编码：</span>
				<input type="hidden" name="id" value="${userCity.id }"/>
				<input type="text"  class="name_input" id="cityId" name="cityId" value="${userCity.cityId }"/>
				<label class="wrong" id="lblCityId" style="display: none;">请输入城市编码！</label>
			</li>
			<li>
				<span><code>*</code>省市名称：</span>
				<input type="text"  class="name_input" id="cityName" name="cityName" value="${userCity.cityName }"/>
				<label class="wrong" id="lblCityName" style="display: none;">请输入城市名称！</label>
			</li>
			<li>
				<span><code>*</code>上级编码：</span>
				<input type="text"  class="name_input" id="parentCityId" name="parentCityId" value="${userCity.parentCityId }"/>
				<label class="wrong" id="lblParentCityId" style="display: none;">请输入上级编码！</label>
			</li>
			<li>
				<span>上级名称：</span>
				<input type="text"  class="name_input" id="patentCityName" name="patentCityName" value="${userCity.patentCityName }"/>
			</li>
			<li>
				<span><code>*</code>省市级别：</span>
				<input type="text"  class="name_input" id="levelCode" name="levelCode" value="${userCity.levelCode }"/>
				<label class="wrong" id="lblLevelCode" style="display: none;">请输入省市级别！</label>
			</li>
			<li>
				<span><code>*</code>排序：</span>
				<input type="text"  class="name_input" id="sortOrder" name="sortOrder" value="${userCity.sortOrder }"/>
...
// 保存字典 
function saveDic(){
	if (checkCityName() && checkParentCityId() && checkLevelCode() && checkSortOrder()) {
		var url = "userCity.do?method=editDict";
