		...
		<form action="" method="post" id="addForm" name="addForm">
			<ul>
				<li><span><code>*</code>手机mac地址段：</span>
					...
					<input type="text" class="name_input" id="macAddress" name="macAddress" value="${phone.macAddress }" />
					<label class="wrong" id="lblMacAddress" style="display: none;">请输入手机mac地址段！</label>
				</li>
				<li><span><code>*</code>手机型号：</span>
					<input type="text" class="name_input" id="phoneType" name="phoneType" value="${phone.phoneType }"/>
...
function saveDic() {
	if (checkMacAddress() && checkPhoneType()) {
		var url = "phone.do?method=editDict";
