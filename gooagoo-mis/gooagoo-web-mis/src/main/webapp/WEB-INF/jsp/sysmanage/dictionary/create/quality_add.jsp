	...
	<div class="user_message">
		<form action="" method="post" id="addForm" name="addForm">
			<ul style="width: 500px;">
				<li><span><code>*</code>商品类型名称：</span>
					<input type="text" class="name_input" id="goodsTypeName" name="goodsTypeName" />
					<label class="wrong" id="lblGoodsTypeName" style="float: none; display: none;">请输入商品类型名称！</label>
				</li>
				<li><span><code>*</code>上级类型编号：</span>
					<input type="text" class="name_input" id="parentGoodsTypeId" name="parentGoodsTypeId" />
					<label class="wrong" id="lblParentGoodsTypeId" style="float: none; display: none;">请输入上级类型编号！</label>
				</li>
				<li><span><code>*</code>点击前图片：</span>
					<input type="text" class="name_input" id="frontPic" name="frontPic" readOnly="readonly" />
				...
				<li><span><code>*</code>点击后图片：</span>
					<input type="text" class="name_input" id="backPic" name="backPic" readOnly="readonly" />
...
function saveDic() {
	if (checkGoodsTypeName() && checkParentGoodsTypeId() && checkFrontPic() && checkBackPic() && checkSortOrder()) {
		var url = "quality.do?method=addDict";
