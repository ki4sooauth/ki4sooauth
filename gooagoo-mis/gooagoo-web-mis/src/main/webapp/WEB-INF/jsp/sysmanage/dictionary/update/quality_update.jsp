	...
	<form action="" method="post" id="addForm" name="addForm">
		<ul style="width: 500px;">
			<li>
				...
				<input type="hidden" name="goodsTypeId" value="${quality.goodsTypeId }"/>
				<input type="text"  class="name_input" id="goodsTypeName" name="goodsTypeName" value="${quality.goodsTypeName }"/>
				<label class="wrong" id="lblGoodsTypeName" style="float: none; display: none;">请输入商品类型名称！</label>
			</li>
			<li>
				<span><code>*</code>上级类型编号：</span>
				<input type="text"  class="name_input" id="parentGoodsTypeId" name="parentGoodsTypeId" value="${quality.parentGoodsTypeId }"/>
				<label class="wrong" id="lblParentGoodsTypeId" style="float: none; display: none;">请输入上级类型编号！</label>
			</li>
			<li>
				<span><code>*</code>点击前图片：</span>
				<input type="text"  class="name_input" id="frontPic" name="frontPic" readOnly="readonly" value="${quality.frontPic }"/>
			...
			<li>
				...
				<input type="text"  class="name_input" id="backPic" name="backPic" readOnly="readonly" value="${quality.backPic }"/>
			...
			<li>
				...
				<input type="text"  class="name_input" id="sortOrder" name="sortOrder" value="${quality.sortOrder }"/>
...
function saveDic() {
	if (checkGoodsTypeName() && checkParentGoodsTypeId() && checkFrontPic() && checkBackPic() && checkSortOrder()) {
		var url = "quality.do?method=editDict";
