...
<div class="popMsg">
	...
	<ul>
		...
		<li>
			...
			<label class="wrong" id="lbDeviceType" style="color:red; width: 120px;float: none;display: none;">请选择设备型号！</label>
		</li>
		<li>
			<span>设备序列号：</span>
