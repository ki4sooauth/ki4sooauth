...
function page(index){
	...
	ajaxToPageByData("shopLid.do?method=queryLidList","resultlist",data);
}

//查询
function queryLidList(){
...
<div class="div_but" >
	<h2 style = "margin: 0;padding: 10;text-align:center;">商家LID查询</h2>
	<ul style = "margin: 0;padding: 5;text-align:center;">
		<li>
			...
			<input type="button" value="查询" onclick="queryLidList()" /> 
	    </li>
	</ul>
</div>
<div class="big_box" id="resultlist"></div>
</body>
</html>