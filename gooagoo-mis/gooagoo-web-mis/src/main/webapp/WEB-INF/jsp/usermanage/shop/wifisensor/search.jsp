...
function page(index){
	...
	ajaxToPageByData("${basePath }/shopWifisensor.do?method=searchWifisensorList","resultlist",data);
}
//查询
function searchWifisensorList(){
	page(varPageIndex);
} */
function page(index){
	if(isEmpty(index) || parseInt(index)<1){
	...
	ajaxToPageByData("shopWifisensor.do?method=searchWifisensorList","resultlist",data);
}
...
<div class="div_but" >
	<h2 style = "margin: 0;padding: 10;text-align:center;">Wifisensor查询</h2>
	...
	<ul style = "margin: 0;padding: 5;text-align:center;">
		<li>&nbsp;&nbsp;&nbsp;请选择实体店：
		    ...
		    <input type="button" value="查询" onclick="searchWifisensorList();" /> 
	    </li>
	</ul>
	</form>
</div>
