...
<body>
	<form id="addForm" method="post">
		<div id="shopbg1" style="background-color:#DC3C14;overflow: hidden; width: 100%; height: 60px; line-height: 59px; margin:58px auto 15px;text-align:center;">
		...
		<table style="margin: 31px 0px 20px 230px;">
			<tr>
				<td>
		...
		<p>
		<div style="padding:0 0 0 303px">起始时间： 
		...
		<br>
		<div style="padding:0 0 0 303px">结束时间： 
	...
	<script type="text/javascript">
		...
		function enter() {
			...
			if (checkForm()) {
				...
				var url = "nominateS.do?method=nominateShop";
