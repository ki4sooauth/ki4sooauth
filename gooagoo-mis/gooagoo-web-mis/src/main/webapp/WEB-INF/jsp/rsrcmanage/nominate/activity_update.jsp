...
<body>
	<form id="addForm" method="post">
		...
		<div style="padding:0 0 0 360px">起始时间： 
			<input id="startTime" name="startTime" type="text" value="<fmt:formatDate value="${activity.startTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" />"
		...
		<div style="padding:0 0 0 360px">结束时间： 
			<input id="endTime" name="endTime" type="text" value="<fmt:formatDate value="${activity.endTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" />"
				onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'${currentTime}'})" class="Wdate" style="cursor: pointer;" /> 
	...
	<script type="text/javascript">
		...
		function enter() {
			...
			if (checkForm()) {
				var url = "nominateA.do?method=updateNominateActivity";
