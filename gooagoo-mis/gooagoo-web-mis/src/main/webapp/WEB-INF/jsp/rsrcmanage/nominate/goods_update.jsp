...
<body>
	<form id="addForm" method="post">
		...
		<div style="padding:0 0 0 360px">起始时间： 
			<input id="startTime" name="startTime" type="text" value="<fmt:formatDate value="${goods.startTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" />"
		...
		<div style="padding:0 0 0 360px">结束时间： 
			<input id="endTime" name="endTime" type="text" value="<fmt:formatDate value="${goods.endTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" />"
	...
	<script type="text/javascript">
		...
		function enter() {
			...
			if (checkForm()) {
				var url = "nominateG.do?method=updateNominateGoods";
