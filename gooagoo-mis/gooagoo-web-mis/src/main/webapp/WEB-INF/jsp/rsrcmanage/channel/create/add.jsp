...
<form id="addForm" method="post">
	<div class="popMsg">
		...
		<ul>
		    <li>
			    <span >请输入渠道名称：</span>
			    <input type="text" value="" id ="channelName" name="channelName" maxlength="32"/>
				<label class="wrong" id="lbMac" style="width: 105px;display: none;">请输入渠道名称！</label>
		    </li> 	       
		</ul>
	</div>
	<div class="popBtn">
		<input type ="button" value="确定" class="left" onclick="save();"/>
...
function save(){
	...
	if(data　!= null && "" != data){
		var url = "channel.do?method=saveChannel";
	    data = $("#addForm").serialize()+"&parentChannelCode="+data;
