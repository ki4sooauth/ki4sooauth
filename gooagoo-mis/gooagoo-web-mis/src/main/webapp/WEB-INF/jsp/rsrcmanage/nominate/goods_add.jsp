...
<body>
	<form id="addForm" method="post" style="width: 95%;">
		...
		<div style="padding:0 0 0 323px;">起始时间： 
		...
		<br>
		<div style="padding:0 0 0 323px;">结束时间： 
		...
		<div style="padding:41px 0 0 390px">
			<input style="width:70px;height:24px;" id="save" type="button" value="保存" onclick="enter()" />
		</div>
		<input name="ids" type="hidden" value="${goods.goodsId }" /> 
	</form>
	<script type="text/javascript">
		...
		function enter() {
			...
			if (checkForm()) {
				var url = "nominateG.do?method=nominateGoods";
