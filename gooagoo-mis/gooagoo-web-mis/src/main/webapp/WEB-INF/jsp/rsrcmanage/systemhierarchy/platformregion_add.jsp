		...
		<form action="" method="post" id="addForm" name="addForm">
			<ul style="width: 500px;">
				<li><span style="width: 140px;"><code>*</code>小平台名称：</span>
					<input type="text" class="name_input" id="platformName" name="platformName" />
				...
				<li><span class="f_b_t" style="width: 130px;">描述：</span>
					<input type="text" class="name_input" id="description" name="description" />
				</li>
...
function savePlat() {
	if (checkPlatformName()) {
		var url = "platformRegion.do?method=addPlatformRegion";
