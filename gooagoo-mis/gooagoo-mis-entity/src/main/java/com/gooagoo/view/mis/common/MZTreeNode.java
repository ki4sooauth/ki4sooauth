...
public class MZTreeNode implements Serializable
{
    ...
    private List<MZTreeNode> children = new ArrayList<MZTreeNode>();//子节点
    ...
    public MZTreeNode(String id, String pId, String name, boolean checked)
    {
        this.setId(id);
        this.setpId(pId);
        this.setName(name);
    ...
    public MZTreeNode(String id, String pId, String name, String click)
    {
        this.setId(id);
        this.setpId(pId);
        this.setName(name);
    ...
    public List<MZTreeNode> getChildren()
    {
        return this.children;
    }

    public void setChildren(List<MZTreeNode> children)
    {
        this.children = children;
    }

    public void addChildren(MZTreeNode zTreeNode)
    {
        if (this.children == null)
        {
            this.children = new ArrayList<MZTreeNode>();
        }
