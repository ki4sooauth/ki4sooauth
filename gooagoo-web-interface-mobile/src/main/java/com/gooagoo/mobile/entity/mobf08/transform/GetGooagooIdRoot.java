package com.gooagoo.mobile.entity.mobf08.transform;
 ...
 *  获取gooagooId 
 */
public class GetGooagooIdRoot implements Serializable
{
	...
	/**
	 * 设置gooagooid 
	 * @param gooagooid	gooagooid 
	 */
	public void setGooagooid(String gooagooid)
	{
		this.gooagooid = gooagooid != null ? gooagooid : "";
	}
