...
public class Goodssequencelist implements Serializable
{
	...
	/** 商品图片url，多张图返回格式为List<String>格式的json串 */
	...
	/**
	 * 设置商品图片url，多张图返回格式为List<String>格式的json串
	 * @param goodsimg	商品图片url，多张图返回格式为List<String>格式的json串
	 */
	...
	/**
	 * 获取商品图片url，多张图返回格式为List<String>格式的json串
	 * @return	商品图片url，多张图返回格式为List<String>格式的json串
	 */
