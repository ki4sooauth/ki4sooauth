...
public class BehaveUtil
{
    ...
    public static void setBehaveMap()
    {
        ...
        behaveValue.put("mobi06", "LID");//接口MOBI06:收集LID信息
        behaveValue.put("mobj01", "TOOLTYPE");//MOBJ02:记录用户使用服务工具行为,1-购物匹配,2-停车记忆,3-点餐,4-结账申请,5-现场导引,6-购物车,7-商品查询,8-远程排号,9-本店订单,10-扫码
    }
