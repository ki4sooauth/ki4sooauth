...
public final class MessageConst
{
     ...
     *收货人信息编号不能为空
     */
    public final static String MOBILE_PARAMETER_CONSIGNEEINFO_IS_NULL = "MOBA41";

    /**
     *收货人姓名不能为空
     */
    public final static String MOBILE_PARAMETER_CONSIGNEENAME_IS_NULL = "MOBA42";

    /**
     *省份信息不能为空
     */
    public final static String MOBILE_PARAMETER_PROVINCE_IS_NULL = "MOBA43";

    /**
     *市区信息不能为空
     */
    public final static String MOBILE_PARAMETER_CITY_IS_NULL = "MOBA44";

    /**
     *县区信息不能为空
     */
    public final static String MOBILE_PARAMETER_AREA_IS_NULL = "MOBA45";

    /**
     *详细地址不能为空
     */
    public final static String MOBILE_PARAMETER_ADDRESS_IS_NULL = "MOBA46";

    /**
     *手机号码和联系电话,两者二选一必填
     */
    public final static String MOBILE_PARAMETER_PHONE_AND_TELPHONE_IS_NULL = "MOBA47";

    /**
     *默认选项不能为空
     */
    public final static String MOBILE_PARAMETER_ISDEFAULT_IS_NULL = "MOBA48";

    /**
     *用户发票抬头信息编号不能为空
     */
    public final static String MOBILE_PARAMETER_RECEIPTID_IS_NULL = "MOBA49";

    /**
     *公司名称不能为空
     */
    public final static String MOBILE_PARAMETER_COMPANYNAME_IS_NULL = "MOBA50";

    /**
     *服务工具类型不能为空
     */
    public final static String MOBILE_PARAMETER_TOOLTYPE_IS_NULL = "MOBA51";
     ...
     *调用接口有误，请选择编辑商品
     */
    public final static String MOBILE_SHOPPINGCART_CALL_API_ERROR = "MOBO06";

    /**
     *添加收货人地址信息失败
     */
    public final static String MOBILE_CONSIGNEEINFO_ADD_FAIL = "MOBP01";

    /**
     *编辑收货人地址信息失败
     */
    public final static String MOBILE_CONSIGNEEINFO_EDIT_FAIL = "MOBP02";

    /**
     *删除收货人地址信息失败
     */
    public final static String MOBILE_CONSIGNEEINFO_DEL_FAIL = "MOBP03";

    /**
     *添加用户发票抬头信息失败
     */
    public final static String MOBILE_RECEIPTINFO_ADD_FAIL = "MOBQ01";

    /**
     *编辑用户发票抬头信息失败
     */
    public final static String MOBILE_RECEIPTINFO_EDIT_FAIL = "MOBQ02";

    /**
     *删除用户发票抬头信息失败
     */
    public final static String MOBILE_RECEIPTINFO_DEL_FAIL = "MOBQ03";
