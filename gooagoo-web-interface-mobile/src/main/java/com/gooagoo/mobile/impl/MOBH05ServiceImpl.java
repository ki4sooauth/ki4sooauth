...
@Service("mobh05")
public class MOBH05ServiceImpl implements ImobileService
{
    @Override
    public String doImobile(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "mobh05"));
