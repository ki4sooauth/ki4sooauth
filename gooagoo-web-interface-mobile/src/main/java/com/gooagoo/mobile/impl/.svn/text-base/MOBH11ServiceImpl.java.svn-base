...
@Service("mobh11")
public class MOBH11ServiceImpl implements ImobileService
{
    ...
    public String doImobile(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "mobh11"));
