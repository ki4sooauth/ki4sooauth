...
@Service("mobh04")
public class MOBH04ServiceImpl implements ImobileService
{
    ...
    public String doImobile(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "mobh04"));
