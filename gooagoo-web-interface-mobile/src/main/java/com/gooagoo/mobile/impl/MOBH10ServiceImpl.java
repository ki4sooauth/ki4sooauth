...
@Service("mobh10")
public class MOBH10ServiceImpl implements ImobileService
{
    ...
    public String doImobile(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "mobh10"));
