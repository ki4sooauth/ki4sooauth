...
@Service("mobh03")
public class MOBH03ServiceImpl implements ImobileService
{
    @Override
    public String doImobile(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "mobh03"));
