...
@Service("mobh02")
public class MOBH02ServiceImpl implements ImobileService
{
    ...
    public String doImobile(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "mobh02"));
