 ...
 */
@Service("gasl09")
public class GASL09ServiceImpl implements IgasService
{
    @Autowired
    ...
    public String doIgas(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            String goodskind = parameter.getString("goodskind");
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gasl09"));
            ...
            this.orderLinkGasService.hurryDish(shopentityid, orderid, tablename, itemserial, goodskind);
            root.setResult("true");
            root.setMsg("店员帮助用户催菜成功");
