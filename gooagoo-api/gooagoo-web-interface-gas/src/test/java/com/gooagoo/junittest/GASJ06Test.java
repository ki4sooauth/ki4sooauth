 ...
 *
 */
public class GASJ06Test extends TestCase
{
    String interfaceCode = "gasj06";//接口编码
    ...
    public void testMacIsNull()
    {
        ...
        root = (DeskQueueTrackRoot) HttpClientUtils.HttpPost(list, root, this.interfaceCode);
    ...
    public void testSuccess()
    {
        ...
        DeskQueueTrackRoot root = new DeskQueueTrackRoot();
        root = (DeskQueueTrackRoot) HttpClientUtils.HttpPost(list, root, this.interfaceCode);
        Assert.assertEquals("获取排号记录成功", root.getMsg().trim());
    }
}
