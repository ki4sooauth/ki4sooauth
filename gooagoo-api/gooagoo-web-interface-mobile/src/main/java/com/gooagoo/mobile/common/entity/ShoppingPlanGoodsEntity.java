 ...
 *  商品列表 
 */
public class ShoppingPlanGoodsEntity implements Serializable
{
    ...
    {
        return "ShoppingPlanGoodsEntity [shoppinggoodsid=" + this.shoppinggoodsid + ", goodsid=" + this.goodsid + ", goodsname=" + this.goodsname + ", goodstypeid=" + this.goodstypeid + ", goodstypename=" + this.goodstypename + ", shopid=" + this.shopid + ", shopname=" + this.shopname + ", isdel=" + this.isdel + ", createtime=" + this.createtime + ", ctimestamp=" + this.ctimestamp + "]";
    }
}