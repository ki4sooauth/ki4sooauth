 ...
 *  购物计划 
 */
public class Usershoppingplanmob implements Serializable
{
	...
	/**  商品列表  */
	private java.util.List<Shoppingplangoodsmob> shoppingplangoodsmob = new java.util.ArrayList<Shoppingplangoodsmob>();
	 ...
	 */
	public void setShoppingplangoodsmob(java.util.List<Shoppingplangoodsmob> shoppingplangoodsmob)
	{
		this.shoppingplangoodsmob = shoppingplangoodsmob;
	}
	 ...
	 * @return	 商品列表 
	 */
	public java.util.List<Shoppingplangoodsmob> getShoppingplangoodsmob()
	{
		return this.shoppingplangoodsmob;
	}

	/**
	 * 添加 商品列表 
	 * @return shoppingplangoodsmob	 商品列表 
	 */
	public Shoppingplangoodsmob addMoreShoppingplangoodsmob() {
		Shoppingplangoodsmob shoppingplangoodsmob = new Shoppingplangoodsmob();
		this.shoppingplangoodsmob.add(shoppingplangoodsmob);
		return shoppingplangoodsmob;
	}
}