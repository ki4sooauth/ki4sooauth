 ...
 *  购物匹配 
 */
public class ShoppingMatchActiveRoot implements Serializable
{
	...
	/** 位置  */
	private java.util.List<Position> position = null;
	 ...
	 * @param position	位置 
	 */
	public void setPosition(java.util.List<Position> position)
	{
	 ...
	 * @return position	位置 
	 */
	public Position addMorePosition() {
