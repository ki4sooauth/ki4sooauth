...
public class GTSC01Test extends TestCase
{

    String interfaceCode = "gtsc01";//接口编码
    ...
    public void testMacIsNull()
    {
        ...
        root = (BillPayRoot) HttpClientUtils.HttpPost(list, root, this.interfaceCode);
    ...
    public void testSuccess()
    {
        ...
        BillPayRoot root = new BillPayRoot();
        root = (BillPayRoot) HttpClientUtils.HttpPost(list, root, this.interfaceCode);
        Assert.assertEquals("查询结账申请信息成功", root.getMsg().trim());
    }
