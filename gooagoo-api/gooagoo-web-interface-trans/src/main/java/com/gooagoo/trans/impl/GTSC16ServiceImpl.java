 ...
 */
@Service("gtsc16")
public class GTSC16ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc16"));
            //校验入参
            ...
            root = this.serveDishOperateTransService.getHurryDishInfo(mac, shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询用户催菜请求成功");
        }
