 ...
 */
@Service("gtsc23")
public class GTSC23ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc23"));
            //校验入参
            ...
            root = this.tableManagerTransService.getUpdatePeopleNumsInfo(mac, shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询修改台头请求成功");
        }
