 ...
 */
@Service("gtsc22")
public class GTSC22ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc22"));
            //校验入参
            ...
            root = this.tableManagerTransService.getCancelTableInfo(mac, shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询撤台请求成功");
        }
