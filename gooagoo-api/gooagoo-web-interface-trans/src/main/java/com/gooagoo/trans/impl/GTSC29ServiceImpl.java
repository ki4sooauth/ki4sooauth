 ...
 */
@Service("gtsc29")
public class GTSC29ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc29"));
            //校验入参
            ...
            root = this.serveDishOperateTransService.findCouponInfo(shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询优惠凭证信息成功");
        }
