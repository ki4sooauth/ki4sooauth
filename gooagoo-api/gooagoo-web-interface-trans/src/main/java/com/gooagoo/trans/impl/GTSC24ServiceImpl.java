 ...
 */
@Service("gtsc24")
public class GTSC24ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc24"));
            //校验入参
            ...
            root = this.tableManagerTransService.getbackDishInfo(shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询退菜请求成功");
        }
