...
public class Orderbaseinfo implements Serializable
{
	...
	/**  订单详细信息  */
	private java.util.List<Orderdetailinfo> orderdetailinfo = new java.util.ArrayList<Orderdetailinfo>();
	...
	/**
	 * 设置 订单详细信息 
	 * @param orderdetailinfo	 订单详细信息 
	 */
	public void setOrderdetailinfo(java.util.List<Orderdetailinfo> orderdetailinfo)
	{
	 ...
	 * @return	 订单详细信息 
	 */
	public java.util.List<Orderdetailinfo> getOrderdetailinfo()
	{
	...
	/**
	 * 添加 订单详细信息 
	 * @return orderdetailinfo	 订单详细信息 
	 */
	public Orderdetailinfo addMoreOrderdetailinfo() {
		Orderdetailinfo orderdetailinfo = new Orderdetailinfo();
		this.orderdetailinfo.add(orderdetailinfo);
