 ...
 */
@Service("gtsc18")
public class GTSC18ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc18"));
            //校验入参
            ...
            root = this.serveDishOperateTransService.getDishWeightConfirmInfo(mac, shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询重量确认成功");
        }
