 ...
 */
@Service("gtsc15")
public class GTSC15ServiceImpl implements ItransService
{
    @Autowired
    ...
    public String doItrans(HttpServletRequest request) throws Exception
    {
        ...
        try
        {
            ...
            //打印log
            GooagooLog.info(InterfaceUtils.getLogMsg(request, "gtsc15"));
            //校验入参
            ...
            root = this.serveDishOperateTransService.getOrderDishInfo(mac, shopentityid, ctimestamp);
            root.setResult("true");
            root.setMsg("查询用户起菜请求成功");
        }
