...
<script type="text/javascript" src="${imgPath }/gus/shop/js/shop_memberInformation.js"></script>
...
<form id="form" name="form">
	 <input  name="currentTime" value="${currentTime}" type="hidden"/>
	 <input  name="shopId" value="${shopId}" type="hidden"/>
		<ul>
	    	<li class="fst">
	        	    <label>姓&#12288;名：</label><input type="text" value="${data.name }" name="name" maxlength="10"/>
	        </li>
	        <li class="sec">
	                <label>手机号码：</label><input type="text" name="mobile" value="${data.mobile }" style="ime-mode:disabled;" onpaste="javascript: return false;" onkeyup="javascript: return ValidateNumber(this,value);" onblur="javascript: return ValidateNumber(this,value);" maxlength="11"/> 
	        </li>
	        <li class="sec">
	        	    <label>身份证号：</label><input class="mail_num" onblur="changeSexandBri()" value="${data.idNo }" type="text" name="idNo" maxlength="18"/>
	        </li>
	        <li class="sec">
	        	<label>性别：</label>
		        <div class="sexSelect">
		        	<c:choose>
		        		<c:when test="${data.sex eq '男'}">
				            <input type="radio" name="sex" value="M" checked="checked"/>男
				            <input type="radio" name="sex" value="F"/>女
		        		</c:when>
		        		<c:when test="${data.sex eq '女'}">
	        ...
	        <li class="sec">
	            <label>出生日期：</label><input class="date" value="${data.birthday }" type="text"  id="startDate" name="birthday" readonly="true">
	        </li>
	        <li>
	        	 <label>通讯地址：</label><input class="addr" value="${data.address }" type="text" name="address" style="width:300px" maxlength="32">
	        </li>
