...
<script type="text/javascript" src="${imgPath }/gus/personal/js/securityQuestion/setSecurityQuestion.js"></script>
	<input type="hidden" name="updateSuccess" value="true"/>
	<input type="hidden" name="messages" value="aaa"/>
		                            	...
		                            	<li class="topLi">
		                                	<samp>系统问题:</samp><select name="scontent" id="content">
		                                		<c:forEach items="${data}" var="d">
			                                    	<option value="${d.sysId},${d.content}">${d.content}</option>
		                                		</c:forEach>
		                                    </select>
		                                    <p class="plineHight"></p>
		                                    <samp>答案:</samp><input maxlength="100" name="answer" type="text" id="sanswer"/>
		                                </li>
		                                <li class="curr">
		                                	<samp>自定义问题:</samp><input maxlength="100" name="content" disabled="disabled" type="text" /><p class="plineHight"></p>                          
		                                    <samp>答案:</samp><input maxlength="100" name="answer" disabled="disabled" type="text" />                            
		                                </li>
                            		</c:when>
                            		<c:otherwise>
		                                <li>
		                                	<samp>自定义问题:</samp><input maxlength="100" name="content"  type="text" />
		                                	<p class="plineHight"></p>                          
		                                    <samp>答案:</samp><input maxlength="100" name="answer" type="text" />                            
		                                </li>
                            		</c:otherwise>
                            	</c:choose>
                            </ul>
