...
<script type="text/javascript" src="${imgPath }/gus/personal/js/personal.js"></script>
		...
		<div class="article">
			...
			<div class="aside">
				<div class="inform_2">
				    ...
				    <div class="menu_2">
				    	<ul>
				        	<li><a href="javascript:void(0)" id="mess" onclick="getPersoanl();" class="curr"><span>个人信息</span></a></li>
				            ...
				            <li><a href="javascript:void(0)" onclick="account();"><span>账户安全</span></a></li>
			...
			<div id="showPic"></div>
			<div class="section" id="personallist"></div>
		</div>
	</div>
	<!--底部-->
