...
<script type="text/javascript" src="${imgPath }/gus/personal/js/account/account.js"></script>
	<form action="" name="accountForm" id="accountForm" method="post">
		<div class="bindingSuccess">
             ...
             <div class="content">
                 	设置用户名:<input class="userName userNameFalse" maxlength="20" name="account" id="account" type="text" />
	                 <span id="yanz"><b class="cur"></b>用户名已经注册<br /></span>
	              	<span class="red2">*</span><span>用户名一经设定，不可更改。</span><br />
				<br />
				<br />
	            <div class="centerD">
	                 <a class="confirm" href="javascript:void(0);" onclick="changeAccound()">提交</a>
	            </div>
           </div>
       </div>
       <div class="tip">
