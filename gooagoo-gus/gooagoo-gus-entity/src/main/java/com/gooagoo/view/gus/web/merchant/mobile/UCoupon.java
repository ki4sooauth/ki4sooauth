...
public class UCoupon implements Serializable
{
    ...
    private Integer maxNumOwner;//个人拥有数量
    ...
    private String couponUseStartTime;//优惠凭证使用开始时间

    private String couponUseEndTime;//优惠凭证使用结束时间

    private String couponPulishStartTime;//优惠凭证发布开始时间

    private String couponPublishEndTime;//优惠凭证发布结束时间
    ...
    public void setCouponUseStartTime(String couponUseStartTime)
    {
    ...
    public void setCouponUseEndTime(String couponUseEndTime)
    {
        this.couponUseEndTime = couponUseEndTime;
    }

    public String getCouponPulishStartTime()
    {
        return couponPulishStartTime;
    }

    public void setCouponPulishStartTime(String couponPulishStartTime)
    {
        this.couponPulishStartTime = couponPulishStartTime;
    }

    public String getCouponPublishEndTime()
    {
        return couponPublishEndTime;
    }

    public void setCouponPublishEndTime(String couponPublishEndTime)
    {
        this.couponPublishEndTime = couponPublishEndTime;
    }
