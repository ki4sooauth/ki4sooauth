...
<script type="text/javascript" src="${imgPath }/gus/cryout/js/cryoutplaza.js"></script>
...
<div class="container">
	<div class="article">
		...
		<div class="section">
			<div class="banner_1">
				<a id="50101" style="display:block;" href="javascript: void(0);"></a>
				<a id="50102" href="javascript: void(0);"></a>
				<a id="50103" href="javascript: void(0);"></a>
			</div>
			<div id="cryoutlist" class="section"></div>
		</div>
      	<div id="shoptypelist" class="all_product_list"></div>
      	<div class="clear"></div>
	</div>
</div>
</form>
