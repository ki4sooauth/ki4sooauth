...
<script type="text/javascript" src="${imgPath}/gus/shoppinglist/js/shoppingList_add.js"></script>
</head>
...
<div class="choice_goods">
	<p class="title">新增清单</p>
	<div class="add_content">
    	<label>清单名称：</label><input type="text"  name="title"  value="${shoppingList.title}" maxlength="20"/><label>预计购物时间：</label><input type="text" name="preShoppingTime" class="date" id="startDate"  readonly="true"  />
