...
<script type="text/javascript" src="${imgPath}/gus/coupon/js/coupon.js"></script>
    ...
    <div class="article">
      ...
      <div class="section" >
         <div class="acc_point_content">
			<div class="banner_1" style="height:355px">
         	...
         	<div class="good_car" style="width:100px;position:fixed;right:10px;bottom:10px;z-index:10;background:#d51112;line-height:30px;color:#fff;padding:0 10px;">已加入收藏<code>0</code>个</div>
            <div class="screen_main">
             <div class="child-li" id="shoplist"></div>
             <div class="child-li">
	             <span class="caption_name">类　　别:</span>
	             <span class="name_links">
	                 <a href="javascript:void(0);" id="t1" onclick="javascript: onType('', this);" class="selected">不　限</a>
	                 <a href="javascript:void(0);" id="t2" onclick="javascript: onType('D', this);">折扣劵</a>
	                 <a href="javascript:void(0);" id="t3" onclick="javascript: onType('C', this);">代金劵</a>
	             </span>
            </div>
            </div>
      ...
      <span id="showPicType"></span>
	  <div class="all_product_list" id="shopTypelist"></div>
      <div class="clear"></div>
    </div>
  </div>
  <!--底部-->
