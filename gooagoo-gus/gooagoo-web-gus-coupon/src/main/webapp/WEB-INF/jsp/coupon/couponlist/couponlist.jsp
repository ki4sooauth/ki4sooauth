...
<c:if test="${data != null && fn:length(data) > 0 }">
	<c:forEach items="${data}" var="FCoupon" >
		<li>
			...
			<p class="addfav"><a id="btn_${FCoupon.couponId}" href="javascript: void(0);" onclick="javascript:sub('${FCoupon.couponId}','${FCoupon.shopId}','${FCoupon.couponName}')"><b></b>加入收藏</a></p>
		</li>
	</c:forEach>
</c:if>
