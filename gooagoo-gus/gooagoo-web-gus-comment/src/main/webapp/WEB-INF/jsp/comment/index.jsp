...
<link href="${imgPath}/gus/common/css/comments.css" rel="stylesheet" type="text/css" />
<link href="${imgPath}/gus/common/css/MyBusiness.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${imgPath }/gus/comment/js/comment.js"></script>
</head>
    ...
    <div class="article">
      ...
      <div class="section" >
	      <div class="screen_main">
	         ...
	         <div class="child-li">
	            <span class="caption_name">时　　间:</span>
	         ...
	         <div class="child-li">
	            <span class="caption_name">评论等级:</span>
	            <span class="name_links">
	            <a href="javascript:void(0);" onclick="onInsertLeva('', this);" class="selected">不&nbsp限</a>
	              <a href="javascript:void(0);" onclick="onInsertLeva('3', this);">好&nbsp评</a>
	              <a href="javascript:void(0);" onclick="onInsertLeva('2', this);">中&nbsp评</a>
	              <a href="javascript:void(0);" onclick="onInsertLeva('1', this);">差&nbsp评</a>
	            </span>
	         </div>
	     </div>
