...
public class CouponAction extends BaseAction
{
    ...
    {
        GusClientUtils.returnJson2(request, response, InterGusConstants.MERCHANT_WEB_GETCOUPONDATA);
    }
    ...
    {
        GusClientUtils.returnJson2(request, response, InterGusConstants.MERCHANT_WEB_FAVORITECOUPON);
    }
