...
public class ActiveAction extends BaseAction
{
    ...
    {
        GusClientUtils.returnJson2(request, response, InterGusConstants.MERCHANT_MOBILE_GETACTIVEDATA);
    }
    ...
    {
        GusClientUtils.returnJson2(request, response, InterGusConstants.MERCHANT_MOBILE_FAVORITEACTIVE);
    }
